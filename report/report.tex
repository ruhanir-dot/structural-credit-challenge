...
\begin{enumerate}
    ...
    \item \textbf{Validate:} After convergence, check the convergence flag utilizing ier (integer flag that indicates sucess or failure of solver)
...
The primary weakness identified in the baseline Merton model is default probability insability.
...
standard deviation exceeds the mean, representing a high signal-to-noise 
